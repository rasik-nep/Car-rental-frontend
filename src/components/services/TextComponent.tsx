    ...
    return (
        <div className="group block cursor-pointer mb-14 pb-8 border-b-2 border-white border-opacity-10 hover:border-opacity-100 items-center transition duration-300" onClick={handleDivClick} key={firstSpan}>
            <div className="flex flex-wrap -mx-4">
                <div className="w-full lg:w-4/12 px-4 mb-8 lg:mb-0">
                    <div className="flex items-start">
                        <span className="hidden group-hover:inline-block mr-5 font-heading text-4xl font-medium text-sky-500">{index}</span>
                        <h4 className="font-heading text-4xl font-medium text-white group-hover:text-sky-500">
                ...
                <div className="w-full lg:w-2/12 px-4 text-right">
                    <span className="inline-block text-white group-hover:text-sky-500 transform rotate-0 group-hover:rotate-90 transition duration-300">
            ...
            {isClicked && <div className="w-full flex items-center px-10">
                <p className="max-w-[40rem] mr-auto text-left text-white tracking-tight leading-snug">{descriptionLong}</p>
